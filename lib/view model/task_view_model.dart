...
class TaskViewmodel extends ChangeNotifier {
 ...
 List<DikrModel> ramadanDikr = [
  ...
  DikrModel(
      ...
      count: 0),
  DikrModel(
      dikrName: "اللَّهُمَّ بَارِكْ لَنَا فِي رَمَضَانَ وَتَقَبَّلْ صِيَامَنَا وَقِيَامَنَا",
      count: 0),
  DikrModel(
      dikrName: "اللَّهُمَّ تَقَبَّلْ مِنَّا إِنَّكَ أَنتَ ٱلسَّمِيعُ ٱلْعَلِيمُ",
      count: 0),
  DikrModel(
      dikrName: "اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، لَا إِلَٰهَ إِلَّا ٱللَّهُ، وَاللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، وَلِلَّهِ ٱلْحَمْدُ",
      count: 0),
];
  List<int> countList = [
    50,
